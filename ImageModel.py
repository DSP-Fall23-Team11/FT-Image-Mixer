...
class ImageModel():
   ...
   def compute_fourier_transform(self,imgByte):
        self.dft = np.fft.fft2(imgByte)
   ...
   def SetImageParams(self,imgByte,edited=False):
      if edited:
         ...
         self.compute_fourier_transform(self.editedimgByte)
      else:
         self.imgByte = imgByte
         self.imgShape = self.imgByte.shape
         self.compute_fourier_transform(self.imgByte)
